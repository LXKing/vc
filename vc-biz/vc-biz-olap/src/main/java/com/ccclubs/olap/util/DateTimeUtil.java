...
import com.ccclubs.olap.bean.PaceBlock;
import com.ccclubs.olap.bean.WeekBean;
...
public class DateTimeUtil {
    ...
    //取得待计算周列表
    public static List<WeekBean> getWeekList(String calDate,int calSize){
...
//        System.out.println(getHour(timeMills));
//        System.out.println(getMinute(timeMills));
//        System.out.println(getSecond(timeMills));
...
//        //Map<Long,DataBlock> blockMap = DateTimeUtil.generateBlockMap(2016,5);
        //System.out.println(DateTimeUtil.getDateTimeByAddMills("2016-11-23 22:13:15",15000));
        //System.out.println(transformMillsToHourStr(1000*60*25));
        getWeekList("2017-08-18 00:00:00",3);
    }
}
