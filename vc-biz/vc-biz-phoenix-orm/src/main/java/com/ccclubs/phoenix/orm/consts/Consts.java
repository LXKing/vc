...
public class Consts {
    ...
    public static final List<String> carStateAllFields= ImmutableList.of("cs_number","current_time","cs_access","add_time","rent_flg",
            ...
            "key_status","light_status","lock_status","net_type","base_lac","base_ci","cur_order"
            );
    //车辆阶段数据默认字段列表
    public static final List<String> carPaceFields=ImmutableList.of("cs_number","current_time","engine_status","add_time","obd_miles","speed","ev_battery","saving_mode","cur_order","speed","longitude","latitude","charging_status");

    //车辆CAN分页查询默认字段列表
    public static final List<String> carCanPageDefaultFields = ImmutableList.of("cs_number","current_time","add_time","can_data");
    //车辆CAN所有字段列表
