package com.ccclubs.job.executor.service;

import com.ccclubs.job.executor.constant.AttachmentConst;
...
public class SendMailService {
     ...
     * @Description: 附件发送
     */
    public void sendMultiPartEmail(String toEmail, String subject,
