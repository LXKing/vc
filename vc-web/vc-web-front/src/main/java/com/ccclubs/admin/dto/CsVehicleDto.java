 ...
 * @author machuanpeng
 */
public class CsVehicleDto implements java.io.Serializable {
    ...
    private String csvAccessText;

    private String csvModelText;

    private String csvMachineText;

    private String csvColorCodeText;

    private String csvLandmarkText;

    private String csvStatusText;

    private String csvDomainText;
    ...
    //主键构造函数
    public CsVehicleDto(Integer id) {
        this.csvId = id;
    }

    //设置非空字段
    public CsVehicleDto setNotNull(Integer csvId, Integer csvAccess, String csvVin, Integer csvModel, Short csvStatus, Date csvAddTime, Date
            csvUpdateTime) {
        this.csvId = csvId;
    ...
    public String getCsvDomainText() {
        return csvDomainText;
    }

    public void setCsvDomainText(String csvDomainText) {
        this.csvDomainText = csvDomainText;
    }

    public String getCsvAccessText() {
        return csvAccessText;
    }

    public void setCsvAccessText(String csvAccessText) {
        this.csvAccessText = csvAccessText;
    }

    public String getCsvModelText() {
        return csvModelText;
    }

    public void setCsvModelText(String csvModelText) {
        this.csvModelText = csvModelText;
    }

    public String getCsvMachineText() {
        return csvMachineText;
    }

    public void setCsvMachineText(String csvMachineText) {
        this.csvMachineText = csvMachineText;
    }

    public String getCsvColorCodeText() {
        return csvColorCodeText;
    }

    public void setCsvColorCodeText(String csvColorCodeText) {
        this.csvColorCodeText = csvColorCodeText;
    }

    public String getCsvLandmarkText() {
        return csvLandmarkText;
    }

    public void setCsvLandmarkText(String csvLandmarkText) {
        this.csvLandmarkText = csvLandmarkText;
    }

    public String getCsvStatusText() {
        return csvStatusText;
    }

    public void setCsvStatusText(String csvStatusText) {
        this.csvStatusText = csvStatusText;
    }
