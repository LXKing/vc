...
public class CalDataToDriveMiles {

    private static Logger logger = Logger.getLogger(CalDataToDriveMiles.class);
...
//                chsMap.put("LJ8E3C1M6GB009071",0);
...
//                partition_sql="a.cs_vin='LJ8E3C1M6GB009071' ";
                ...
                pace_rows.createOrReplaceTempView("dw_drive_miles_basic_ds");
                sparkSession.sql(" insert overwrite table dw_drive_miles_basic " +
                        "partition(cs_vin) " +
                        "select cs_number,row_no,start_soc,end_soc,changed_miles,start_miles,end_miles,start_time,end_time,pace_timemills,cs_vin " +
                        "from dw_drive_miles_basic_ds  ");
            }
        }
        sparkSession.stop();
    }
