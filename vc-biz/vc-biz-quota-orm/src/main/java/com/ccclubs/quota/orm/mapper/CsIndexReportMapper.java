...
public interface CsIndexReportMapper {
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") CsIndexReport record, @Param("example") CsIndexReportExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("record") CsIndexReport record, @Param("example") CsIndexReportExample example);
}