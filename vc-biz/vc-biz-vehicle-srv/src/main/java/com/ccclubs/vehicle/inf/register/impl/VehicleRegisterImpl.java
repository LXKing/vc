...
public class VehicleRegisterImpl implements VehicleRegisterInf {
     ...
     */
    private boolean validateVehicleRegister(String appId, RegisterOutput output, List<CsVehicle> passList, VehicleRegisterInput... inputs) {
        ...
        for (VehicleRegisterInput input : inputs) {
            ...
            //machine = terminalService.queryTerminalByTeNo(input.getTeNo());
