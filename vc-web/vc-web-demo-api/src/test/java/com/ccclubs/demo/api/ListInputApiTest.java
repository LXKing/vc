...
import com.ccclubs.demo.mod.ListData;
import com.ccclubs.demo.mod.ListInput;

public class ListInputApiTest {
 
	@Test
	public  void test() throws Exception, Throwable {
		CloseableHttpClient httpclient = HttpClients.createDefault();
		HttpPost httpPost = new HttpPost("http://127.0.0.1:8081/listInput");
		ListInput input = new ListInput();
		List<ListData> list = new ArrayList<ListData>();
		ListData e = new ListData();
		e.setTest("");
		list.add(e);
		e = new ListData();
		e.setTest("1");
		...
		httpPost.addHeader("apiId", "apiId");
