...
public class CCCLUBS_60 implements IMessageBody {
        ...
        if (additionalItem != null) {
            ...
            if (SUBCODE_03 == subFucCode) {
                return AccurateOperationUtils
                        .mul(gpsStatus.getLongitude(), 0.000001)
    ...
    public BigDecimal getTriggerGpsLatitude() {
        ...
        if (additionalItem != null) {
            ...
            if (SUBCODE_03 == subFucCode) {
                return AccurateOperationUtils
                        .mul(gpsStatus.getLatitude(), 0.000001)
                        .setScale(6, BigDecimal.ROUND_HALF_UP);
            } else {
                return AccurateOperationUtils
    ...
    public BigDecimal getOil() {
        ...
        if (additionalItem != null) {
            ...
            return AccurateOperationUtils.mul(oil.getOil(), 0.1)
                    .setScale(1, BigDecimal.ROUND_HALF_UP);
        } else {
            return new BigDecimal(0);
        }
    ...
    public MachineAdditional_GpsAssistStatus getGpsAssistStatus() {
        IMachineAdditionalItem additionalItem = null;
        for (IMachineAdditionalItem item : getAdditionals()) {
            if ((item.getAdditionalId() & 0xFF) == 155) {
                additionalItem = item;
                break;
            }
        }
     ...
     * 高精度经纬度【车辆自身经纬度】
     */
    public MachineAdditional_HighPrecisionGPS getHighPrecisionGPS() {
        IMachineAdditionalItem additionalItem = null;
        for (IMachineAdditionalItem item : getAdditionals()) {
            if ((item.getAdditionalId() & 0xFF) == 156) {
                additionalItem = item;
                break;
            }
        }
        if (additionalItem != null) {
            MachineAdditional_HighPrecisionGPS machineAdditionalHighPrecisionGPS = (MachineAdditional_HighPrecisionGPS) additionalItem;
            return machineAdditionalHighPrecisionGPS;
        } else {
            return null;
        }
    }
    ...
    public Integer getControlStatus() {
        ...
        if (additionalItem != null) {
            ...
            return ((controlStatusWithMask.getMask() << 8) + controlStatusWithMask
                    .getControlStatus());
        } else {
            return null;
        }
        ...
        try {
            ...
            while (buff.hasRemain()) {
                ...
                IMachineAdditionalItem item = MachineAdditionalFactory
                        .createMachineAdditionalFactory(additionalId, additionalLength,
                                additionalBytes);
                if (item != null) {
