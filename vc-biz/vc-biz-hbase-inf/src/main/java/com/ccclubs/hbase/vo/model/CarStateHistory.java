package com.ccclubs.hbase.vo.model;
...
public class CarStateHistory {
    ...
    //子域
    private Long cs_host;

    private String cs_car_no;
    //关联车辆
    private Long relate_car;
    //添加时间
    ...
    public Long getCs_host() {
        return cs_host;
    }

    public void setCs_host(Long cs_host) {
        this.cs_host = cs_host;
    }

    public Long getRelate_car() {
        return relate_car;
    }

    public void setRelate_car(Long relate_car) {
        this.relate_car = relate_car;
    }
