...
public class MqttStateConsumer{
    ...
    public void processNor(List<String> messageList) {
        MqttStateRunner mqttStateRunner=new MqttStateRunner(messageList);
        StorageThreadPool.getThreadPool().execute(mqttStateRunner);
    }
    ...
    class MqttStateRunner implements Runnable{
        private List<String> messageList;

        public MqttStateRunner(List<String> messageList) {
