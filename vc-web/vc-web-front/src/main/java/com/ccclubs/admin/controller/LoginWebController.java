...
/**
 * *************************** 版权所有：车厘子 所有权利 创建日期: 2017-9-15 创建作者：zkm 类名称　：LoginWebController.java
 * 版　　本： 功　　能： 最后修改： 修改记录： ****************************
 */
@RestController
public class LoginWebController {
  ...
  public Object getAccessToken(@RequestParam("username")
      String strUsername, @RequestParam("password")
      String strPassword) {
