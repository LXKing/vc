...
public class MessageFactory {
    ...
    public Message getMessage(String topic, String tags, MqMessage mqttMessage) {
        ...
        if (StringUtils.notEmpty(srvHost.getShTopic())) {
            topic = srvHost.getShTopic().trim();
        }

        return new Message(topic,
                tags + String.valueOf(srvHost.getShId()),
     ...
     */
    public Message getMessage(String topic, String tags, T808Message t808Message) {
        CsMachine csMachine = queryTerminalService.queryCsMachineBySimNo(t808Message.getSimNo());
        if (csMachine == null || csMachine.getCsmId() <= 0) {
            return null;
        }
     ...
     */
    public Message getMessage(String topic, String tags, GBMessage gbMessage) {
