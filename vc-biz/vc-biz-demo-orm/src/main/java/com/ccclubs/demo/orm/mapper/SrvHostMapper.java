...
import com.ccclubs.demo.orm.model.SrvHost;
import com.ccclubs.demo.orm.model.SrvHostExample;
...
public interface SrvHostMapper {
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") SrvHost record, @Param("example") SrvHostExample example);
