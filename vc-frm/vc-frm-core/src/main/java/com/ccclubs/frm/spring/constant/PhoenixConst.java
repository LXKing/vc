...
public class PhoenixConst {
    ...
    public static final String PHOENIX_CAR_STATE_HISTORY_NOR="PHOENIX_CAR_STATE_HISTORY_NOR";
    public static final String PHOENIX_CAR_STATE_HISTORY_EXP="PHOENIX_CAR_STATE_HISTORY_EXP";
