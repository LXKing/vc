...
import com.ccclubs.olap.protocol.protocolmodel.evnet.EV_09_can_item;
 ...
 */
public class EVcan_GB {



    public static String getCan_gb(List<EV_09_can_item> canItemsList ) {

        CanToGbJson canToGbJson =new CanToGbJson();
        ...
        for (EV_09_can_item can_item : canItemsList) {
...
//                    int ll=   (can_item.getmCanData5()&0xff)*256+(can_item.getmCanData6()&0xff);
        ...
        //
        if(gb_02_01.getVehicleStatus()<0){

            if (gb_02_02_item.getDriveMotorSpeed()>0){
                gb_02_01.setVehicleStatus(1);//启动状态
            }else{
                if(gb_02_01.getChargeStatus()>0){
                    gb_02_01.setVehicleStatus(3);//其他
                }else{
                    gb_02_01.setVehicleStatus(2);//熄火
                }
...
///==================
        ...
        //
        canToGbJson.setVehicleRealData(gb_02);

        String jsonString= JSON.toJSONString(canToGbJson);
        //
        return jsonString;
    }
