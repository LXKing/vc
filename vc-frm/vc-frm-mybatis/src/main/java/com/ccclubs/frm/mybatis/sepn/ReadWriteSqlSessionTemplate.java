...
public class ReadWriteSqlSessionTemplate extends SqlSessionTemplate {
	...
	public SqlSessionFactory getSqlSessionFactory() {
		...
		SqlSessionFactory targetSqlSessionFactory = this.targetSqlSessionFactory
				.get(ReadWriteSqlSessionContextHolder.getDataSourceKey());
	...
	private class SqlSessionInterceptor implements InvocationHandler {
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			...
			try {
				...
				if (ReadWriteSqlSessionTemplate.this.exceptionTranslator != null
