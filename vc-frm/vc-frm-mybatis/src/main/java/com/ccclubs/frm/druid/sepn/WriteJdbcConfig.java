...
@Configuration
public class WriteJdbcConfig {
	private Logger logger = LoggerFactory.getLogger(this.getClass());
	//
	@Value("${druid.driver}")
	String driverClass;
	//写
	@Value("${druid.writer.url}")
	String writerJdbcUrl;
	@Value("${druid.writer.username}")
	String writerUsername;
	@Value("${druid.writer.password}")
	...
	public DataSource writeDataSource(){
		...
		try {
			...
			logger.error("writeDataSource", e);
		}
